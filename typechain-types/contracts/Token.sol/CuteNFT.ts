...
export interface CuteNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface CuteNFT extends BaseContract {
  connect(runner?: ContractRunner | null): CuteNFT;
  waitForDeployment(): Promise<this>;

  interface: CuteNFTInterface;
