...
export interface CoderNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface CoderNFT extends BaseContract {
  connect(runner?: ContractRunner | null): CoderNFT;
  waitForDeployment(): Promise<this>;

  interface: CoderNFTInterface;
