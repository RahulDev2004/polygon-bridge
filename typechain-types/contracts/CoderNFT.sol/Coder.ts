...
export interface CoderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface Coder extends BaseContract {
  connect(runner?: ContractRunner | null): Coder;
  ...
  getprompt: TypedContractMethod<[tokenId: BigNumberish], [string], "view">;
  ...
  setURI: TypedContractMethod<
    [uri: string, tokenId: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  updatePrompt: TypedContractMethod<
    [prmpt: string, tokenId: BigNumberish],
    [void],
    "nonpayable"
  >;
